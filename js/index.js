...
//temas
function roxerde() {
    var cor = document.querySelector("#css");
    cor.setAttribute("href", "css/index.css");
}

function azurelo() {
    var cor = document.querySelector("#css");
    cor.setAttribute("href", "css/color-1.css");
}

function branzul() {
    var cor = document.querySelector("#css");
    cor.setAttribute("href", "css/color-2.css");
}

function pretelho() {
    var cor = document.querySelector("#css");
    cor.setAttribute("href", "css/color-3.css");
}

function verdosa() {
    var cor = document.querySelector("#css");
    cor.setAttribute("href", "css/color-4.css");
}